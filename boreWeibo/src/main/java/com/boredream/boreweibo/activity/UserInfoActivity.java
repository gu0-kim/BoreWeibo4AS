...
public class UserInfoActivity extends BaseActivity implements OnClickListener, OnCheckedChangeListener {
    ...
    private void initView() {
        title = new TitleBuilder(this).setTitleBgRes(R.drawable.userinfo_navigationbar_background).setLeftImage(R.drawable.navigationbar_back_sel).setLeftOnClickListener(this).build();
        // 获取标题栏信息,需要时进行修改
    ...
    private void initListView() {
        ...
        plv_user_info.setOnLastItemVisibleListener(new OnLastItemVisibleListener() {
        ...
        plv_user_info.setOnPlvScrollListener(new OnPlvScrollListener() {
            ...
            public void onScrollChanged(int l, int t, int oldl, int oldt) {
                ...
                if (minImageHeight - scrollY < maxImageHeight) {
                    //Imageview用的centercrop，layout实际对imageview进行放大或缩小
                    iv_user_info_head.layout(0, 0, iv_user_info_head.getWidth(), minImageHeight - scrollY);
                } else {
                    iv_user_info_head.layout(0, -scrollY - (maxImageHeight - minImageHeight), iv_user_info_head.getWidth(), -scrollY - (maxImageHeight - minImageHeight) + iv_user_info_head.getHeight());
                }
            }
        });
        ...
        iv_user_info_head.addOnLayoutChangeListener(new OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                Log.w("tag", "------(" + curScrollY + ")-------(" + (bottom - oldBottom) + ")----");
        ...
        plv_user_info.setOnScrollListener(new OnScrollListener() {
            ...
            public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
                iv_user_info_head.layout(0, user_info_head.getTop(), iv_user_info_head.getWidth(), user_info_head.getTop() + iv_user_info_head.getHeight());
    ...
    private void loadStatuses(final long requestPage) {
        weiboApi.statusesUser_timeline(user == null ? -1 : user.getId(), userName, requestPage, new SimpleRequestListener(this, null) {
